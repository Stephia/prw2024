<?php
// Leitura do número da coluna a ser considerada
$colunaConsiderada = intval(readline());
...
// Realização da operação na coluna considerada
for ($i = 0; $i < 12; $i++)
    $operacao += $matriz[$i][$colunaConsiderada];

// Se a operação for média, calcula a média dividindo pela quantidade de linhas (12)
if ($operacaoChar == 'M')
    $operacao /= 12;
